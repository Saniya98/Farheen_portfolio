...
import { RiCloseLine, RiMenu3Line } from "react-icons/ri"; // Assuming you're using Remix Icons
import { NAVIGATION_LINKS } from "../constants";

// Define NAVIGATION_LINKS
// const NAVIGATION_LINKS = [
//   { label: "Projects", href: "#projects" },
//   { label: "Skills", href: "#skille" },
      ...
      <nav className="fixed left-0 right-0 z-50 lg:top-4">
        ...
        <div className="mx-auto hidden max-w-xl items-center justify-center rounded-full border border-white/30 py-2 backdrop-blur-lg lg:flex">
          <div className="flex items-center justify-between gap-6">
            <div>
              <a href="/">
                <span className="uppercase">Saniya Farheen</span>
              </a>
            </div>
        ...
        <div className="py-2 backdrop-blur-md lg:hidden">
          <div className="flex items-center justify-between">
            <div>
              <a href="#">
                <span className="pl-2 uppercase">Saniya Farheen</span>
              </a>
            </div>
